...
namespace T_Market
{
    public class Cls_Con
    {
        ...
        public Cls_Con(string Connectionstring) => Get_SQl_Con(Connectionstring);
        ~Cls_Con() => GC.SuppressFinalize(this);
        ...
        public SqlConnection Get_SQL_Con() { if (Is_Connected()) { return SqlCon; } return null; }
